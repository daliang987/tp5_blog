<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\article\edit.html";i:1585408813;s:66:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\base.html";i:1585319215;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <form class="form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <?php else: ?>
                            <div class="col-md-10" id="bd">
                                <textarea id="bdeditor" style="height:300px;width:100%;"></textarea>
                            </div>
                            <div class="col-md-10" id="md">
                                <div id="mdeditor">
                            ...
                            <?php endif; if($oldArc['editor_type']=='bd'): ?>
...
<script>
    ...
    require(['hdjs'], function (hdjs) {
        ...
        if ($('#bd').find('textarea').attr('name') != undefined) {
            //md编辑器隐藏
            $('#md').hide();
