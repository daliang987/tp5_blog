<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\article\bdstore.html";i:1585496756;s:66:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\base.html";i:1585319215;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-md-11">
                <form class="form-horizontal" method="post">
                        ...
                        <div class="col-md-10">
                            <select class="form-control" name="cate_id">
                                ...
                                <option value="<?php echo $vo['cate_id']; ?>" <?php if($vo['cate_id']==session('formdata.cate_id')): ?>
                                    selected<?php endif; ?>><?php echo $vo['_cate_name']; ?> </option> <?php endforeach; endif; else: echo "" ;endif; else: if(is_array($catedata) || $catedata instanceof \think\Collection || $catedata instanceof \think\Paginator): $i = 0; $__LIST__ = $catedata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> <option value="<?php echo $vo['cate_id']; ?>"><?php echo $vo['_cate_name']; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="arc_tag" class="form-control" value="<?php echo session('formdata.arc_tag'); ?>">
                        </div>
                        <div class="col-md-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="checkbox" id="tag_checkbox">
                                ...
                                <label>
                                    <input type="checkbox" <?php if(in_array($tag['tag_id'],session('formdata.tag'))): ?>checked<?php endif; ?> name="tag[]" value="<?php echo $tag['tag_id']; ?>"><?php echo $tag['tag_name']; ?></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="input-group" style="margin-top:5px;">
                                ...
                                <?php else: ?>
                                <img src="__STATIC__/img/nopic.jpg" class="img-responsive img-thumbnail" width="150">
                                <em class="close" style="position:absolute; top: 0px; right: -14px;" title="删除这张图片"
                                    onclick="removeImg(this)">×</em>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10" id="bd">
                            <textarea id="bdeditor" name="arc_content"
                                style="height:300px;width:100%;"><?php echo session('formdata.arc_content'); ?></textarea>
                        </div>
...
<script>
    ...
    require(['hdjs'], function (hdjs) {
        ...
        hdjs.ueditor('bdeditor', {}, function (e) {
            console.log(e);
        });
