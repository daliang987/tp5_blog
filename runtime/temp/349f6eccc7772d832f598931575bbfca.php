<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\phpStudy\WWW\tp5_blog\public/../application/admin\view\login\index.html";i:1517235409;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="<?php echo url('login'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <img src="<?php echo url('vcode'); ?>" alt="captcha" onclick=this.src=this.src+'?'+Math.random() /> 
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-8">
