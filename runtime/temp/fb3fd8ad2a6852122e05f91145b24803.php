<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\webset\index.html";i:1586025974;s:66:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\base.html";i:1585997021;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container-fluid">
        <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" name="webset_value" value="<?php echo $webset['webset_value']; ?>"
                        id="websetvalue" onfocus="getWebsetValue(this)" onblur="changeValue('<?php echo $webset['webset_id']; ?>',this)">
                </td>
