<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\tag\store.html";i:1517930367;s:66:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\base.html";i:1585997021;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-md-offset-2 col-md-8">
                <form class="form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <input type="submit" class="form-control col-md-12 btn-info" value="创建标签">
                        </div>
                    </div>
                </form>
            </div>
