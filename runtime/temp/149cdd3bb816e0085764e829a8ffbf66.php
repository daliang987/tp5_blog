<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\xampp\htdocs\blog/application/admin\view\article\edit.html";i:1585304665;s:53:"D:\xampp\htdocs\blog/application/admin\view\base.html";i:1585304261;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="checkbox">
                                ...
                                <label>
                                    <input type="checkbox" <?php if(in_array($tag['tag_id'],$tag_ids)): ?>checked<?php endif; ?>
        ...
        $('#btn-add-tag').click(function () {
            if ($('#arc_tag').val().trim()) {
                $.ajax({
                    ...
                    type: 'post',
                    data: { 'tag_name': $('#arc_tag').val() },
                    success: function (data) {
                        data = JSON.parse(data);
                        if (data.valid == 1) {
                            $('#tag_checkbox').append('<input type="checkbox" name="tag[]" checked value="' + data.tagid + '">' + $('#arc_tag').val() + '</label>');
                        } else {
                            alert(data.msg);
                        }
                    }
