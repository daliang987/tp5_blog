<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\webset\edit.html";i:1517930367;s:66:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\base.html";i:1585997021;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel panel-info">
    <div class="panel-body">
        <ul class="nav nav-tabs">
            ...
            <li  class="active">
                <a href="<?php echo url('admin/webset/store'); ?>">编辑配置</a>
            </li>
        </ul>
    </div>
    <div class="container-fluid">
            ...
            <div class="col-md-offset-2 col-md-8">
                <form class="form-horizontal" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="webset_name" value="<?php echo $webset['webset_name']; ?>" class="form-control" placeholder="配置名称">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-md-2 control-label">配置值</label>
                        <div class="col-md-8">
                            <input type="text" name="webset_value" value="<?php echo $webset['webset_value']; ?>" class="form-control" placeholder="配置值">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-md-2 control-label">描述</label>
                        <div class="col-md-8">
                            <input type="text" name="webset_desc" value="<?php echo $webset['webset_desc']; ?>" class="form-control" placeholder="描述">
                        </div>
                    </div>
                    <input type="hidden" name="webset_id" value=<?php echo $webset['webset_id']; ?>>
                    <div class="form-group">

                        <div class="col-md-offset-2 col-md-8">
                            <input type="submit" class="form-control col-md-12 btn-info" value="修改配置">
                        </div>
                    </div>
                </form>
            </div>
