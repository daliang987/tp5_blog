<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\tag\edit.html";i:1517930367;s:66:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\base.html";i:1585997021;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel panel-info">
    <div class="panel-body">
        <ul class="nav nav-tabs">
            <li>
                <a href="<?php echo url('admin/tag/index'); ?>">标签首页</a>
            </li>
            <li class="active">
                <a href="<?php echo url('admin/tag/edit'); ?>">标签编辑</a>
            </li>
        </ul>
    </div>
    <div class="container-fluid">
            ...
            <div class="col-md-offset-2 col-md-8">
                <form class="form-horizontal" method="post">
                    <div class="form-group">
                        <label for="" class="col-md-2 control-label">标签名称</label>
                        <div class="col-md-8">
                            <input type="text" name="tag_name" value="<?php echo $olddata['tag_name']; ?>" class="form-control">
                        </div>
                    </div>
                    <input type="hidden" name="tag_id" value="<?php echo $olddata['tag_id']; ?>">
                    <div class="form-group">

                        <div class="col-md-offset-2 col-md-8">
                            <input type="submit" class="form-control col-md-12 btn-info" value="修改标签">
                        </div>
                    </div>
                </form>
            </div>
