<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\article\store.html";i:1585411350;s:66:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\base.html";i:1585319215;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-md-11">
                <form class="form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="number" name="arc_sort" value="10" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="input-group">
                                <input class="form-control" name="arc_thumb" readonly="" value="">
                            ...
                            <div class="input-group" style="margin-top:5px;">
                                <img src="__STATIC__/node_modules/hdjs/static/image/nopic.jpg"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea name="arc_digist" id="" rows="3" class="form-control"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10" id="bd">
                            <textarea id="bdeditor" name="arc_content" style="height:300px;width:100%;"></textarea>
                        </div>
...
<script>
    ...
    require(['hdjs'], function (hdjs) {
        //默认显示md编辑器，百度编辑器隐藏
        $('#bd').hide();
        $('#bd').find('textarea').removeAttr('name');
        ...
        $('#switch_editor').click(function () {
            // alert($('#bdeditor').is(':hidden'));

            //百度编辑器隐藏状态点击按钮
            if ($('#bdeditor').is(':hidden')) {

                //百度编辑器显示
                $('#bd').show();
                $('#bd').find('textarea').attr('name', 'arc_content');

                //md编辑器隐藏
                $('#md').hide();
                $('#md').find('textarea').removeAttr('name');
                ...
                //md编辑器显示
                $('#md').show();
                $('#md').find('textarea').attr('name', 'arc_content');
