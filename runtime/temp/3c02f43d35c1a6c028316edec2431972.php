<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\article\mdedit.html";i:1585495205;s:66:"D:\phpstudy_pro\WWW\tp5\public/../application/admin\view\base.html";i:1585319215;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    require(['hdjs'], function (hdjs) {
        ...
        $('#switch_editor').click(function(){
            hdjs.confirm('切换编辑器所有更改将不保存，确定切换吗?', function () { 
                location.href='<?php echo url("admin/article/bdedit"); ?>';
            })
        })
